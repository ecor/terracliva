...
clmdexcliva <- function(x,timex,valmin=1,months=c(12,1,2,3),dryspell_starts_in_months=TRUE,dryspell_ends_in_months=FALSE,start_day=1,fun_aggr="max",thres_value=150,set_thres_value_as_na=FALSE,min_dry_spell_length=3,na.rm=FALSE,summary_regress=FALSE,signif=0.1,...) {
